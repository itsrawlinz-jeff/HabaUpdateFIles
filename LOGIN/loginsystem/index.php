...
if($num>0)
{
// $extra="./choose-payment.php?amount=50&user=$useremail:";
$extra="welcome.php";
            ...
            <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark"
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="http://habadatingclub.com/index.php" style="color:white;">HOME
                            </a>
                        </li>
                        <!--  <li class="nav-item">
                ...
                <div id="horizontalTab" style="display: block; width: 100%; margin: 0px; color:black !important;">
                    <ul class="resp-tabs-list">
                        ...
                        <li class="resp-tab-item lost" aria-controls="tab_item-2" role="tab">
                            <div class="top-img"><img src="images/top-key.png" alt="" /></div><span>Forgot
                                Password</span>
                        </li>
                        <div class="clear"></div>
                    </ul>
                                ...
                                <div class="login">
                                    ...
                                    <form name="login" action="" method="post">
                                        <input type="text" class="text" name="uemail" value=""
                                            placeholder="Enter your registered email"><a href="#"
                                            class=" icon email"></a>
